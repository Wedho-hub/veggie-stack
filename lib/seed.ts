...
const products = [
  ...
  {
    name: 'Citrus Box',
    description: 'A sweet mix of Valencia oranges, mandarins and lemons, perfect for juicing or snacking.',
    price: 79,
    category: 'fruit',
    inStock: true,
  ...
  {
    name: 'Mango Box',
    description: 'Juicy, fragrant mangoes at peak ripeness — sourced from Limpopo orchards.',
    price: 89,
    category: 'fruit',
    inStock: true,
    farmOrigin: 'Limpopo',
    imageUrl: 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=800&q=85&fit=crop&auto=format',
    tags: ['mango', 'tropical', 'fruit'],
  },
  ...
  {
    name: 'Capsicum Pack',
    description: 'Crunchy red, yellow and green capsicums — great for stir-fries, roasting or raw.',
    price: 45,
    category: 'vegetable',
    inStock: true,
    farmOrigin: 'Philippi',
    imageUrl: 'https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=800&q=85&fit=crop&auto=format',
    tags: ['capsicum', 'peppers', 'vitamin c'],
  },
  {
  ...
  {
    name: 'Mason Jar Set 6-pack',
    description: 'Glass mason jars for overnight oats, smoothies, meal prep and pantry storage.',
    price: 149,
    category: 'gadget',
    inStock: true,
    imageUrl: 'https://images.unsplash.com/photo-1573246123716-6b1782bfc499?w=800&q=85&fit=crop&auto=format',
    tags: ['mason jar', 'storage', 'kitchen'],
  },
  {
    name: 'Bamboo Cutting Board',
    description: 'Sustainably sourced bamboo board. Naturally antibacterial and gentle on knives.',
    price: 199,
    category: 'gadget',
    inStock: true,
  ...
  // ── SUPPLEMENTS ───────────────────────────────────────────────
  {
    name: 'Spirulina Powder 200g',
    description: 'Pure spirulina. South African sourced, cold-processed. 60% protein by weight.',
    price: 189,
    category: 'supplement',
    inStock: true,
  ...
  {
    name: 'Plant Protein Blend 500g',
    description: 'A complete amino-acid blend of pea, rice and hemp protein. Unflavoured.',
    price: 299,
    category: 'supplement',
    inStock: true,
    imageUrl: 'https://images.unsplash.com/photo-1579722820258-26a8c8a3d22e?w=800&q=85&fit=crop&auto=format',
    tags: ['protein', 'plant-based', 'powder'],
  },
  {
  ...
  {
    name: 'Chlorella Tablets 90s',
    description: '90 tablets of pure chlorella — a detoxifying, nutrient-dense algae superfood.',
    price: 169,
    category: 'supplement',
    inStock: true,
    imageUrl: 'https://images.unsplash.com/photo-1611072172377-02b2cb4a0d20?w=800&q=85&fit=crop&auto=format',
    tags: ['chlorella', 'detox', 'superfood'],
  },
]
